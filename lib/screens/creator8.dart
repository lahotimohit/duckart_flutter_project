...
class Creator8 extends StatefulWidget
{
  @override
  State<Creator8> createState() => _Creator2State();
}

class _Creator2State extends State<Creator8> {
  @override
  ...
  return AppBar(
      ...
      title: ListTile(
        leading: CircleAvatar(
          backgroundImage: AssetImage(creators[7].image),
        ),
        title: Row(
          children: [
