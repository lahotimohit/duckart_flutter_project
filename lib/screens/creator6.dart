...
class Creator6 extends StatefulWidget
{
  @override
  State<Creator6> createState() => _Creator6State();
}

class _Creator6State extends State<Creator6> {
  @override
  ...
  return AppBar(
      ...
      title: ListTile(
        leading: CircleAvatar(
          backgroundImage: AssetImage(creators[5].image),
        ),
        title: Row(
          children: [
